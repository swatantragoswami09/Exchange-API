...
app.use("/user", userRoutes); // CRUD operation
app.use("/transactions", transactionRoutes); // Buy & SELL crypto from Portfolio
app.use("/cryptos", cryptoRoutes); // get Crypto & update crypto
app.use("/login", loginRoute); // login to the exchange
app.use("/news", newsRoutes); // get latest news
